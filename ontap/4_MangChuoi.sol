...
contract StringArrayExample {
    ...
    function addString(string memory _string) public {
        strings.push(_string); // Corrected to use push
    }
    ...
    function getAllStrings() external view returns (string memory) {
